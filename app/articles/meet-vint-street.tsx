  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="flex-row items-center gap-4 p-4 bg-white border-b border-gray-200">
        ...
        <Text className="text-lg font-inter-bold text-black">{title || 'Meet Vint Street'}</Text>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <View className="w-full aspect-[16/7] overflow-hidden">
          ...
          {description && (
            <View className="absolute left-4 right-4 bottom-6">
              <Text className="text-2xl font-inter-bold text-white mb-3">{title || 'Meet Vint Street'}</Text>
        ...
        <View className="p-4">
          ...
          <View className="w-full p-4 bg-gray-100 rounded-lg mt-8">
            <Text className="text-xl font-inter-bold text-black text-center mb-3">Ready to Explore?</Text>
            ...
            <TouchableOpacity onPress={handleBrowseItems} className="w-full bg-black py-4 rounded-lg">
              <Text className="text-white text-base font-inter-bold text-center">Browse Items</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
